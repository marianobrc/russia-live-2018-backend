...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            request_url = API_ENDPOINT_URL + "seasons/892?api_token={}&include=fixtures:filter(stage_id|1727),fixtures.localTeam,fixtures.visitorTeam,fixtures.stage, fixtures.venue".format(API_KEY)
            print(request_url)
            try:
